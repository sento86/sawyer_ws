...
robot_hostname="021606CP00038.local"

# Set *Either* your computers ip address or hostname. Please note if using
# your_hostname that this must be resolvable to the Robot.
#your_ip="192.168.XXX.XXX"
#your_ip="192.168.1.110" #to be used when controlling the robot
your_ip="127.0.0.1" #used for simulation

#your_hostname="my_computer.local"
#your_hostname="lr101095-HP-Laptop-15-bs0xx.local"
